...
function RUI:DetailsSettings(layout)
		_detalhes_global["__profiles"]["SoulUI"] = {
			...
			["instances"] = {
				{
					...
					["row_info"] = {
						...
						["font_face_file"] = "Interface\\Addons\\ElvUI_Soul\\Media\\GOTHICB.TTF",
